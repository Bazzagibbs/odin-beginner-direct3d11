...
wnd_proc :: proc "stdcall" (hWnd: win.HWND, uMsg: win.UINT, wParam: win.WPARAM, lParam: win.LPARAM) -> (result: win.LRESULT) {
        ...
        case win.WM_CREATE: 
                ...
                win.SetWindowLongPtrW(hWnd, win.GWLP_USERDATA, int(lParam))
        ...
        case win.WM_SIZE:
                app_state := (^App_State)(uintptr(win.GetWindowLongPtrW(hWnd, win.GWLP_USERDATA)))
...
main :: proc() {
        ...
        {      
                ...
                vertex_buffer_desc := d3d11.BUFFER_DESC {
                        ByteWidth = u32(size_of(f32) * len(vertex_data)),
                        Usage     = .IMMUTABLE,
